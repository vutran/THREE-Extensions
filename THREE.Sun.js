...
THREE.Sun = function(texturePath, size, color, flares) {
  ...
  if(texturePath !== undefined && flares !== undefined) this.create(texturePath, size, color, flares);
 ...
 * @return void
 */
THREE.Sun.prototype.create = function(texturePath, size, color, flares) {
  // lens flares
  var sun = this,
      flare0 = false,
      flare1 = false,
 ...
 * @return void
 */
THREE.Sun.prototype.updateFlares = function() {
